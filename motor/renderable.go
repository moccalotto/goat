...
type Renderable interface {
	...
	Finalize() // called before drawing can happen
	Draw()
	Clone() Renderable
}
...
func CreateSpriteFromAtlas(shaderAlias, atlas, subTexName string, verts, texCoords []float32, indeces []uint32) *Sprite {
...
func CreateSprite(shaderAlias, textureAlias string, verts, texCoords []float32, indeces []uint32) *Sprite {
...
func (R *Sprite) Draw(camMatrix, objTranslationMatrix mgl32.Mat3) {
